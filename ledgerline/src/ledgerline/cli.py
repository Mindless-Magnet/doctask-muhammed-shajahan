...
def seed(
    ...
    out: Path = typer.Option(Path("./corpus"), help="Where to write the generated documents."),
    variant: str = typer.Option("a", help="Corpus variant: 'a' or 'b'. Use 'b' for a second run."),
) -> None:
